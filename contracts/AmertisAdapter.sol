...
abstract contract AmertisAdapter is Maintainable {
    using SafeERC20 for IERC20;

    event AmertisAdapterSwap(
    ...
    function recoverERC20(
        ...
        require(_tokenAmount > 0, "AmertisAdapter: Nothing to recover");
        IERC20(_tokenAddress).safeTransfer(msg.sender, _tokenAmount);
        emit Recovered(_tokenAddress, _tokenAmount);
    }

    function recoverNAD(uint256 _amount) external onlyMaintainer {
        require(_amount > 0, "AmertisAdapter: Nothing to recover");
    ...
    function swap(
        ...
        emit AmertisAdapterSwap(_fromToken, _toToken, _amountIn, _amountOut);
    }
