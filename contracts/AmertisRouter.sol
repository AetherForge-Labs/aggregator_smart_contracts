...
import "./interface/IAmertisRouter.sol";
import "./interface/IAdapter.sol";
import "./interface/IERC20.sol";
import "./interface/IWETH.sol";
import "./lib/SafeERC20.sol";
import "./lib/Maintainable.sol";
import "./lib/AmertisViewUtils.sol";
import "./lib/Recoverable.sol";
import "./lib/SafeERC20.sol";

contract AmertisRouter is Maintainable, Recoverable, IAmertisRouter {
    using SafeERC20 for IERC20;
    using OfferUtils for Offer;

    address public immutable WNATIVE;
    address public constant NATIVE = address(0);
    string public constant NAME = "AmertisRouter";
    ...
    function _applyFee(
        ...
        require(_fee >= MIN_FEE, "AmertisRouter: Insufficient fee");
    ...
    function findBestPathWithGas(
        ...
        require(
            ...
            "AmertisRouter: Invalid max-steps"
        );
    ...
    function _swapNoSplit(
        ...
        require(
            ...
            "AmertisRouter: Insufficient output amount"
        );
        for (uint256 i = 0; i < _trade.adapters.length; i++) {
    ...
    function swapNoSplitFromNative(
        ...
        require(
            ...
            "AmertisRouter: Path needs to begin with WETH"
        );
    ...
    function swapNoSplitToNative(
        ...
        require(
            ...
            "AmertisRouter: Path needs to end with WETH"
        );
    ...
    function risks() external pure returns (string memory) {
        return
            "Amertis router contract is yet to be audited, so use at your own risk- Dluguhs frpphq";
    }
}
